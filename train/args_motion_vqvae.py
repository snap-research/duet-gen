...
checkpoints_dir = os.path.join('checkpoints', dataset_name, 'baseline')
if not os.path.exists(checkpoints_dir):
    os.makedirs(checkpoints_dir)
num_genres = 10
predict_velocity = False
## VQVae architecture hyper parameters
model_name = 'Hierarchical_VQVAE_TwoPerson'
output_emb_width = 512
genre_emb_dim = 50
p_emb_dim = 50
code_dim = 512
code_num = 1024
code_levels = [7, 5, 5, 5, 5]
down_t = 2
stride_t = 2
width = 512
depth = 3
...
def arg_parse(is_train=False, load_exp=None):
    ...
    parser.add_argument("--code_levels", type=int, default=code_levels, help="code levels for FSQ")
    ...
    parser.add_argument('--vq_norm', type=str, default=vq_norm, choices=['LN', 'GN', 'BN'],
    ...
    parser.add_argument('--num_quantizers', type=int, default=num_quantizers, help='num_quantizers for RVQ')
    parser.add_argument('--shared_codebook', action="store_true")
    parser.add_argument('--quantize_dropout_prob', type=float, default=quantize_dropout_prob, help='quantize_dropout_prob for RVQ')
